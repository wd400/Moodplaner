          ...
          playing.playlist.audios.asMap().forEach((int index, AudioPlayer.Audio audio) {
            this._playlist.add(
              ListTile(
                ...
                trailing: this._currentTitle == audio.metas.title ? Icon(
                  Icons.music_note,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: this._isInfoShowing ? null: FloatingActionButton(
        onPressed: this._currentTitle == null
            ? null
            : () {
                if (this._isPlaying) {
                  this._playPauseController.forward();
                            ...
                            child: Row(
                              ...
                              children: [
                                FloatingActionButton(
                                  mini: true,
                                  onPressed: this._currentTitle == null ? null : () {
...
SizedBox(height: 30,child:
                                  ...
                                  Marquee(
                   //                 text:"abc",
                                   text: this._currentTitle  ?? language!.STRING_NOW_PLAYING_NOT_PLAYING_TITLE,
...
//////////////////////////////////////////////////////////
                  ...
                  AnimatedBuilder(
                    ...
                    child: SingleChildScrollView(child:this._playlistList),
                    builder: (context, child) => Container(
