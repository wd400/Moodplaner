                  ...
                  padding: EdgeInsets.only(left: 12.0),
                    ...
                    onPressed: () {
                      if (this._textFieldController.text == '') {
                        ...
                        context.read(homeAddressProvider).update(homeAddress:'');
                //        Provider.of<Server>(context, listen: false).update(homeAddress: '');
                        ...
                        .then((http.Response response) {
                          if (response.body == VERIFICATION_STRING) {
                            ...
                            context.read(homeAddressProvider).update(homeAddress:this._textFieldController.text);
                      //      Provider.of<Server>(context, listen: false).update(homeAddress: this._textFieldController.text);
                        ...
                        .catchError((exception) {
                          ...
                          context.read(homeAddressProvider).update(homeAddress:configuration.homeAddress);
